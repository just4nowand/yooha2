...
with col1:
    ...
    st.image(ex_image, width=100, use_column_width='never', caption='유재석(yoojaesuk)', use_column_width=True)
with col2:
    ex_image2 = Image.open("hadoyoung.jpeg")
    st.image(ex_image2, width=100, use_column_width='never', caption='하도영(hadoyoung)', use_column_width=True)
